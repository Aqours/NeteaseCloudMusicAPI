...
require_once 'CryptoCloudMusic.php';
...
class CloudMusicAPI extends CryptoCloudMusic
{
    ...
    public function get_search_detail($s, $limit = 20, $offset = 0, $type = 1)
    {
     ...
     * @return mixed
     */
    public function get_play_url($song_ids, $br = 999000)
    {
     ...
     * @return mixed
     */
    public function get_song_detail($song_ids)
    {
        $ids = is_array($song_ids) ? $song_ids : [$song_ids];
     ...
     * @return mixed
     */
    public function get_song_lyric($song_id)
    {
     ...
     * @return mixed
     */
    public function get_artist_detail($artist_id)
    {
     ...
     * @return mixed
     */
    public function get_playlist_detail($playlist_id)
    {
     ...
     * @return mixed
     */
    public function get_mv_detail($mv_id)
    {
     ...
     * @return string
     */
    public function get_cover_image($pic_id)
    {
     ...
     * @return string
     */
    private function pic_id_to_url($pic_id)
    {
    ...
    private function arr_to_str($bytes)
    {
        $str = '';
