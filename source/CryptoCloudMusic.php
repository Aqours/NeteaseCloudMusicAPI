...
class CryptoCloudMusic
{
    ...
    const COOKIE = 'os=pc; osver=Microsoft-Windows-10-Professional-build-16299-64bit; appver=2.1.0.145894; channel=netease; __remember_me=true';
    const REFERER = 'http://music.163.com/';
    const USERAGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.89 Safari/537.36';
